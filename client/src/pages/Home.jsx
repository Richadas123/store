...
//         const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/v1/allbooks`);
...
//         <h1 className='text-3xl font-semibold text-gray-800 dark:text-white'>Books List</h1>
//         <Link to='/create'>
