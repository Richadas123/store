...
//           <BsInfoCircle className='text-2xl text-green-800 hover:text-blue' />
//         </Link>
//         <Link to={`/update/${book._id}`}>
//           <AiOutlineEdit className='text-2xl text-yellow-600 hover:text-blue' />
//         </Link>
//         <Link to={`/delete/${book._id}`}>
//           <MdOutlineDelete className='text-2xl text-red-600 hover:text-blue' />
//         </Link>
//       </div>
//       {showModal && (
